...
1. Remove policies completely, moving to a fully cloud-managed detection model that supports custom detections together with alerts for high-fidelity, security-focused scenarios, generated by Defender for Cloud Apps' out-of-the-box policies.
