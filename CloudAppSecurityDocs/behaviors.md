...
1. By default, disable policies that generate behaviors. This means that policies will keep sending behaviors but stop sending alerts. This phase is currently in public preview.
