...
In future phases, we'll add more behavior types, and policies that generate alerts may change according to their accuracy.
...
| join BehaviorEntities on AlertId
```
