...
From the **Identities** page, you can take governance actions such as suspend an app or go to the account settings page. For a full list of governance actions, see the [governance log](governance-actions.md).
...
You can manually apply the **Confirm user compromised** action by going to the **User page**, choosing the three dots at the end of the row, and then selecting **Confirm user compromised**.
