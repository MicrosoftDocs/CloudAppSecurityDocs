...
- Directly from the [Cloud App Security portal](https://portal.cloudappsecurity.com/), click on the **User actions** control and choose whether to require the user to sign in again, suspend the user, or confirm user compromised.
