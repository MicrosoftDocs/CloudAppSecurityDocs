...
1. Verify that there are blocked file activities:
    ...
    1. If you're protecting the file with a security label or custom permissions, in the **Activity description**, make sure the file extension is one of the following supported file types:
