...
|Log collector status: Disconnected|No data received in the last 24 hours from any of the linked data sources.|Check the log export setting on your appliance and verify they are set correctly.|
