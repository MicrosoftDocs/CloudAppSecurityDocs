...
|New discovered service|This is an alert about Shadow IT--a new app was detected by Cloud Discovery.|<ul><li>Assess the risk of the service based on the app catalog.</li><li>Drill down into the activity to understand usage patterns and prevalence.</li><li>Decide whether to sanction or unsanction the app.<br /><br />For unsanctioned apps:<br /><br /> <ul><li>You may want to block use in your proxy or firewall.</li><li>If it's unsanctioned and you have a sanctioned app in the same category, you can export a list of users of the unsanctioned app, and then contact them to migrate them to the sanctioned app.</li></ul></li></ul>|  
