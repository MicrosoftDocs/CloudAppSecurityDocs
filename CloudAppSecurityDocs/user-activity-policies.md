...
> 
    ...
    >             - In case of guest user, there may be cases where the "User From Group" filter will not recognize the account by its domain. To make sure all guest users are included you can use the "External users" as the group if it meets your needs for the policy.
    >             
