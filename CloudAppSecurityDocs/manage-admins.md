...
- **Cloud App Security administrator**: Allows full access and permissions in Cloud App Security. This role does not grant the ability to manage admins in Cloud App Security, unlike **Global administrator** or **Security administrator**.
