...
| Data usage |See the data usage by the app in the tenant and plot the data usage for SharePoint and Exchange resources. You can filter usage insights by priority accounts only. |
