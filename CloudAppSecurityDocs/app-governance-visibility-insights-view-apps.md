...
| Data usage |See the data usage by the app in the tenant and plot the data usage for Exchange, SharePoint, OneDrive and Teams resources. You can fliter usage insights by priority accounts only |
