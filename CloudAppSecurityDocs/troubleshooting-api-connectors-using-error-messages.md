...
> |Microsoft.Office.Compliance.Audit.DataServiceException: Tenant 998cea7e-35cd-46a5-ab3c-8ec88a45d7d5 does not exist or {"error":"code":"AF20023","message":"The subscription was disabled."|Office 365|Audit logging is not enabled in Office 365|Enable audit logging in Office 365. [Learn more](connect-office-365-to-microsoft-cloud-app-security.md#how-to-connect-office-365-to-cloud-app-security)|
...
> |Get user: Success Get events: Request failed with status code 403|Zendesk|The Zendesk user that is configuring the integration is no longer a Zendesk admin, or your Zendesk license is unsupported.|Upgrade the Zendesk user who configured the connector to admin (from Zendesk admin portal), or see [here](https://docs.microsoft.com/en-us/cloud-app-security/connect-zendesk-to-microsoft-cloud-app-security#prerequisites) that your Zendesk license is supported.|
