---
title: Govern apps discovered by Microsoft Defender for Endpoint
description: This article describes how to govern Microsoft Defender for Endpoint discovered apps.
ms.date: 12/10/2020
ms.topic: how-to
---
# Govern apps discovered by Microsoft Defender for Endpoint
...
1. In Microsoft Defender Security Center, go to **Settings** > **Advanced features**, and then select **Custom network indicators**. For information about network indicators, see [Create indicators for IPs and URLs/domains]((/microsoft-365/security/defender-endpoint/indicator-ip-domain).
