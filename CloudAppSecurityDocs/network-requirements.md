...
> [!NOTE]
>
> - If your firewall requires a static IP address access list and does not support URL addresses, allow the log collector to initiate outbound traffic to the [Microsoft Azure datacenter IP ranges](https://www.microsoft.com/download/details.aspx?id=56519) on port 443.
