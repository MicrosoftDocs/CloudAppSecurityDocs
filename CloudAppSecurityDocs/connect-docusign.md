...
- Due to DocuSign’s API limitation, in order to have SaaS Security Posture management (SSPM) support the user required to have DocuSign **"account_read account_write and user_read organization_read"** permissions.
