...
[Upgrade to Microsoft Cloud App Security](https://www.microsoft.com/security/business/cloud-app-security) to receive the full suite of Cloud Access Security Broker (CASB) capabilities offered by Microsoft Cloud App Security.
