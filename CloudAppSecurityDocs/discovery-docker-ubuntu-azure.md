...
2.	After the machine is up, open the ports by:
    ...
    |----|----|----|----|----|
    |caslogcollector_ftp|21|TCP|<Your appliance's IP address>|Any|
    |caslogcollector_ftp_passive|20000-20099|TCP|<Your appliance's IP address>|Any|
    |caslogcollector_syslogs_tcp|601-700|TCP|<Your appliance's IP address>|Any|
    |caslogcollector_syslogs_udp|514-600|UDP|<Your appliance's IP address>|Any|
