...
Microsoft Cloud App Security currently operates in datacenters in the United States, Europe, and the UK (each a "Geo"). Your tenant account will be created in a Geo based on the country/region you chose when you signed up. Specifically, your data will be stored in a data center in the Geo nearest to that location.
