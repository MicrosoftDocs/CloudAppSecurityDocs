...
- **Governance actions in apps** - Granular actions can be enforced per app, specific actions vary depending on app terminology.
  ...
  - **Trash** – Move the file to the trash folder. (Box, Dropbox, Google Drive, OneDrive, SharePoint, Cisco Webex)
   ...
   ![policy_create alerts.](media/classic-policy_create-alerts.png)
...
- **Governance actions in apps** - Granular actions can be enforced per app, specific actions vary depending on app terminology.
  ...
  ![Defender for Cloud Apps activity policy governance actions.](media/classic-activity-policy-ref6.png)
...
To view the governance log, in the menu bar, click the settings cog ![settings icon.](media/classic-settings-icon.png "settings icon") and then select **Governance log**.
