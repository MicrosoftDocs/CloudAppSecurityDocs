...
|File policy and Files|File|[Put in admin quarantine](use-case-admin-quarantine.md)|Removes any permissions from the file and moves the file to a quarantine folder under the user's root drive. This permits the admin to review the file and move it.|Office 365 SharePoint, OneDrive for Business, Box|
