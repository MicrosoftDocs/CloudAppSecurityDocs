...
|                              Activity policy, Accounts                              |               Account               |              Require user to sign-in again              |                                         Revokes all refresh tokens and session cookies issues to applications by the user. This will prevent access to any of the organization's data and will force the user to sign into all applications again.                                         |                                    G Suite                                     |
