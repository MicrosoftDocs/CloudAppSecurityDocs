---
title: Configure automatic log upload for continuous reports on a virtual appliance - Deprecated
...
7. If available, choose the network **Connection** and select **Next**.
