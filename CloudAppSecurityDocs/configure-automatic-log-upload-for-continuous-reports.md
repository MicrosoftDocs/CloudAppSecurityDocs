...
### Step 6 - Create custom continuous reports
...
3. Under the **Filters** you can filter the data by data source, by [user group](user-groups.md), or by [IP address tags and ranges](ip-tags.md).
