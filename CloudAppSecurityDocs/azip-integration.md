...
> - In the label configuration, permissions should be assigned to any authenticated user or all users in your organization so Defender for Cloud Apps can read label information. 
