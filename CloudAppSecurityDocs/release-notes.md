...
-	The new unified app permissions page enables you to more easily investigate the permissions your users have given third party apps. By clicking on Investigate > App permissions, you can now view a list of all the permissions your users gave to third-party apps with a page of app permissions per connected app that enables you to better compare between the various apps and the permissions granted.  For more information, see [Manage app permissions](manage-app-permissions.md).
...
-	Support for Microsoft Teams to Office 365 activity logs and alerts was completely rolled out for all tenants.
