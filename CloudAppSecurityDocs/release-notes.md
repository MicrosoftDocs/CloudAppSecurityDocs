...
The Microsoft Data Classification Service provides a unified information protection experience across Office 365, Azure Information Protection and Microsoft Cloud App Security. It allows you to extend the same data classification framework to the third-party cloud apps that are protected by MCAS, leveraging the decisions you already made across an even greater number of apps. 
...
For more information, see [Scoped deployments](scoped-deployments.md).
