...
>**On November 15th 2021, Cloud App Security will update its IP addresses in the "app connectors" section. Please update the IP addresses in your third-party apps accordingly. For more information, see [appconnectors sectio](https://docs.microsoft.com/en-us/cloud-app-security/network-requirements#app-connector)**  
