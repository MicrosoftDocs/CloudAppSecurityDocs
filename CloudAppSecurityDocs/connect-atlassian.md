...
> - Activities from 'Atlassian Access' audit log is fetched by Defender for Cloud apps. Other activities are not fetched currently. See [Product Audit Logs](https://support.atlassian.com/security-and-access-policies/docs/track-organization-activities-from-the-audit-log/).
