...
> [!NOTE]
> For line-of-business apps, tenant admins will need to provide consent to having required data sent outside the current compliance boundary and to select partner teams within Microsoft.
>
