...
11. Under **Create service account key**, choose **New service account**, and type any name, for example **Service account 1**. Under **Role**, choose **Project** and then **Editor**. Under **Key type**, choose **P12** and click **Create**. Select the **Enable G Suite Domain-wide Delegation** check box and click **Save**.  
  
     ![Create service account key in Google](./media/google9.png "google9")  
  
12.  A P12 certificate file is saved to your computer.  
...
15. Copy the **Service account ID** assigned to your service - you need it later.  
  
     ![google service account ID](./media/google13.png "google13")  
  
16. Open the Google menu by clicking the three horizontal lines next to Google Cloud Platform in the title bar. Select **API manager** followed by **Dashboard**.  
...
18. Fill in the following information:
    ...
    -   Under **Drive Integration** type the following URL under **Open URL:**  
