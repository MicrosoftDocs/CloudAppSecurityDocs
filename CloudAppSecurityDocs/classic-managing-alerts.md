...
1. From the **Alerts** page, select **Open** for the **Resolution Status**.
    ...
    ![Alerts resolution status page.](media/classic-alerts.png "alerts")
...
|Compromised account|This type of alert is triggered when Defender for Cloud Apps identifies an account that was compromised. This means there's a very high probability that the account was used in an unauthorized way.|We recommend that you suspend the account until you can reach the user and make sure they change their password.|
