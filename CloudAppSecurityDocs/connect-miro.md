...
![Create a new Miro developer team](media/connect-miro/miro-create-new-team.png)
...
![Create a new Miro app](media/connect-miro/miro-create-new-app.png)
...
![Enable oAuth scopes on Miro app](media/connect-miro/miro-provide-permissions.png)
...
![Install Miro app in the team](media/connect-miro/miro-install-app.png)
